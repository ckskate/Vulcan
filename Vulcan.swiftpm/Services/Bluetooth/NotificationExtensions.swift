...
extension Notification {
    static func deviceDiscovered(_ device: Volcano) -> Notification {
        return Notification(name: .deviceDiscovered,
                            object: nil,
                            userInfo: ["device": device])
    }
    
    static func deviceConnected() -> Notification {
        return Notification(name: .deviceConnected,
                            object: nil,
                            userInfo: nil)
    }
    
    static func servicesDiscovered(_ services: [CBService]) -> Notification {
        return Notification(name: .servicesDiscovered,
                            object: nil,
